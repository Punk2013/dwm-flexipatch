...
static const Key on_empty_keys[] = {
	...
	{ 0,        XK_e,          spawn,                  {.v = filemanagercmd } },
	{ 0,        XK_x,          spawn,                  {.v = termcmd } },
};
...
static const Key keys[] = {
	...
	{ MODKEY,                       XK_Escape,     mpdcontrol,             {0} },
  	...
  	{ MODKEY,                       XK_c,      spawn,          SHCMD ("gnome-terminal")},
	{ MODKEY,                       XK_e,      spawn,          SHCMD ("nemo")},
	{ MODKEY,                       XK_Next,   spawn,          SHCMD ("amixer sset Master 5%- unmute")},
	...
	{ MODKEY,                       XK_Control_R, spawn,       SHCMD ("playerctl play-pause")},
	{ MODKEY,                       XK_Left,   spawn,          SHCMD ("playerctl previous")},
	{ MODKEY,                       XK_Right,  spawn,          SHCMD ("playerctl next")},
	{ MODKEY,                       XK_Down,   spawn,          SHCMD ("playerctl volume 0.05-")},
	{ MODKEY,                       XK_Up,     spawn,          SHCMD ("playerctl volume 0.05+")},
